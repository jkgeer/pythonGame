...
import functions.py
print "Welcome to Chapter 3: Hung Jury" 
print " "
...
if 'proper Pale Ale' in king_rebuttal:
  print " "
  ...
  print " "
  exile = raw_input("As the wagon carrying you and your fellow exiles travels down a path out of the kingdom, a swarm of marauding bandits charges past you in the direction of the kingdom. In the melee, you're set free from your chains and begin to escape! Suddenly though, you see the enemy's camp, and their supplies curiously unguarded. Do you " + "\"poison their stores\"" + ' or '+ "\"scurry away into the forest\""+'?'))
  if 'poison their stores' in exile:
      print " "
      print "You open up your flask and sprinkle a particularly nasty concoction into the various kegs scattered around the camp! Surely this will deal the enemy a crippling blow when they retreat for the night. Congratulations! You will assuredly be hailed a heroine upon your return to Karflooglesville...assuming you return. But will you? Stay tuned to the project to find out!"
      print " "
  if 'scurry away to the forest' in exile:
      print " "
...
if 'mastery over brew' in king_rebuttal:
  ...
  important_choice = raw_input("Do you " + "\"tend to the aid of your lover\"" + ' or " + "\"tend to the aid of the prince\"" + ' while the king is distracted?") 
  if 'tend to the aid of your lover' in important_choice:
      print " "
      ...
      print "import barmaid_level1.py"
